      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-8 flex gap-4 justify-center">
          ...
          <button
            ...
            disabled={deleting}
            className="px-6 py-3 bg-destructive text-destructive-foreground rounded-lg hover:opacity-90 hover:shadow-lg hover:scale-105 transition-all duration-200 font-semibold disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:shadow-none"
          >
            Delete Recipe
          </button>
        </div>
